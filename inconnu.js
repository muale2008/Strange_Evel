...
const BOT_NAME = process.env.BOT_NAME || "Strange MD mInI BoT";
...
const AUTO_STATUS_MSG = process.env.AUTO_STATUS_MSG || "© 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈🥷STRANGE 𝙼𝙳 𝙼𝙸𝙽𝙸 𝙱𝙾𝚃";
const DEV = process.env.DEV || 'STRANGE Mᴅ';
                ...
                await conn.sendMessage(from, {  
                    ...
                    contextInfo: {  
                        ...
                        forwardedNewsletterMessageInfo: {  
                            ...
                            newsletterName: "Strange MD mInI BoT",  
                            serverMessageId: 200  
                        },  
                        externalAdReply: {  
...
function generateMenu(userPrefix, sessionId) {
    ...
    let menuText = `╭─『Strange MD mInI BoT』─╮
...
function gracefulShutdown() {
  ...
  isShuttingDown = true;
  console.log("\n🛑 Shutting down strange evel server...");
